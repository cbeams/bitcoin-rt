	...
	<body>
						...
						<ul class="nav">
							...
							<li class="dropdown" id="menu-resources">
								...
								<ul class="dropdown-menu">
									...
									<li><a href="http://static.springsource.org/spring/docs/4.0.x/javadoc-api/index.html?org/springframework/web/socket/package-summary.html"><i class="icon-home"></i> Spring WebSocket API Docs</a></li>
								</ul>
							</li>
						</ul>
					</div><!--/.nav-collapse -->
		...
		<div class="container">
			<div class="page-header">
				<h1>bitcoin-rt <small>Spring</small></h1>
			</div>
		...
		<div id="aboutModal" class="modal" style="display: none;">
			...
			<div class="modal-body">
				<h4>bitcoin-rt for Spring 4.0</h4>
				<p>
				...
				<p>
					This implementation uses Spring 4.0's WebSocket support to
					implement client-server communication via WebSockets
					(incl. fallbacks).
				</p>
				<hr>
			</div>
			...
			$(function() {
				...
				function connectToServer() {
					...
					socket.onopen = function() {
						console.log('SockJS onopen: Connected.');
					};

					socket.onmessage = onMessage;

					socket.onclose = function() {
						console.log('SockJS onClose executed');
					};
